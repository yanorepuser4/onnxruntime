...
#endif
ORT_REGISTER_TENSOR_TYPE(UnpackedInt4);
ORT_REGISTER_TENSOR_TYPE(UnpackedUInt4);
...
ORT_REGISTER_SPARSE_TENSOR_TYPE(UnpackedInt4);
ORT_REGISTER_SPARSE_TENSOR_TYPE(UnpackedUInt4);
#endif
...
ORT_REGISTER_SEQ_TENSOR_TYPE(UnpackedInt4);
ORT_REGISTER_SEQ_TENSOR_TYPE(UnpackedUInt4);
...
#define ORT_REGISTER_OPTIONAL_ORT_TYPE(ORT_TYPE)        \
  ...
  ORT_REGISTER_OPTIONAL_TYPE(ORT_TYPE, UnpackedInt4);       \
  ORT_REGISTER_OPTIONAL_TYPE(ORT_TYPE, UnpackedUInt4);
...
void RegisterAllProtos(const std::function<void(MLDataType)>& reg_fn) {
...
#endif
  REGISTER_TENSOR_PROTO(UnpackedInt4, reg_fn);
  REGISTER_TENSOR_PROTO(UnpackedUInt4, reg_fn);
...
#endif
  REGISTER_SPARSE_TENSOR_PROTO(UnpackedInt4, reg_fn);
  REGISTER_SPARSE_TENSOR_PROTO(UnpackedUInt4, reg_fn);
#endif
  ...
  REGISTER_SEQ_TENSOR_PROTO(UnpackedInt4, reg_fn);
  REGISTER_SEQ_TENSOR_PROTO(UnpackedUInt4, reg_fn);
...
#define REGISTER_OPTIONAL_PROTO_ORT_TYPE(ORT_TYPE, reg_fn)   \
  ...
  REGISTER_OPTIONAL_PROTO(ORT_TYPE, UnpackedInt4, reg_fn);       \
  REGISTER_OPTIONAL_PROTO(ORT_TYPE, UnpackedUInt4, reg_fn);
...
#endif
    case TensorProto_DataType_INT4:
      return DataTypeImpl::GetTensorType<UnpackedInt4>()->AsTensorType();
    case TensorProto_DataType_UINT4:
      return DataTypeImpl::GetTensorType<UnpackedUInt4>()->AsTensorType();
...
#endif
    case TensorProto_DataType_INT4:
      return DataTypeImpl::GetSequenceTensorType<UnpackedInt4>()->AsSequenceTensorType();
    case TensorProto_DataType_UINT4:
      return DataTypeImpl::GetSequenceTensorType<UnpackedUInt4>()->AsSequenceTensorType();
...
#endif
    case TensorProto_DataType_INT4:
      return DataTypeImpl::GetSparseTensorType<UnpackedInt4>()->AsSparseTensorType();
    case TensorProto_DataType_UINT4:
      return DataTypeImpl::GetSparseTensorType<UnpackedUInt4>()->AsSparseTensorType();
...
#endif
ORT_REGISTER_PRIM_TYPE(UnpackedInt4);
ORT_REGISTER_PRIM_TYPE(UnpackedUInt4);
